            ...
            <div class="flex justify-center gap-10 my-3">
                <div class="flex flex-col justify-center items-center">
                    ...
                    <div class="flex justify-center items-center gap-3">
                        ...
                        <input @input="fetchData" v-model="rangeValueDay" class="block accent-red-400" type="range"
                            name="slider" value="0" min="0" max="30">

                        <label class="block w-14 text-center">{{ rangeValueHour }} saat</label>
                        <input @input="fetchData" v-model="rangeValueHour" class="block accent-red-400" type="range"
                            name="slider" value="23" min="1" max="23">
                    </div>
                </div>
            </div>
...
export default {
    ...
    methods: {
        ...
        updateRect() {
            ...
            /*   
            rect.bindPopup(function (layer) {
                // Fetch the rect area detail from the backend
                // And show in the popup
            });
           */
